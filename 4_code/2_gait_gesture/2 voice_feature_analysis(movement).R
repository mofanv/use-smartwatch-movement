...
for(i in 3:11){
        ...
        png(paste0("4_results/gait_gesture/Fig_AOV_3voice/", nameF,".png"), width = 1800, height = 1200, res = 300)
        ...
        png(paste0("4_results/gait_gesture/Fig_AOV_3voice/0paper_", nameF,".png"), width = 1400, height = 800, res = 300)
        p <- ggplot(resultsSE, aes(x=vectorX, y=vectorY, group=1)) +
                geom_line() +
                geom_errorbar(aes(ymin=vectorY-ci,ymax=vectorY+ci),width=0.1) +
